		...
		<div id="tab-content" style="padding: 15px 10px 5px; clear: both;">
			...
			<table class="table">
				<tr>
					...
					<td align="right">
						<button type="button" class="btn" onclick="javascript:location.href='${pageContext.request.contextPath}/admin/eventManage/${category}/list?${query}';">리스트</button>
					</td>
				</tr>
			</table>
		</div>		
			...
			<table class="table table-border table-form">
				<tbody>
					...
					<tr>
						<td>당첨 방식</td>
						<td>
							<input type="radio" name="winEvent" value="1" id="winEvent1" class="form-control" checked="checked"> <label for="winEvent1">순위 없음</label>
							&nbsp;&nbsp;
